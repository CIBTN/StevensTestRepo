...
def botprogram():
    ...
    schedule.every().thursday.at("11:44").do(postit,Resource) #Schedule library function to run postit function at friday at 10am (8am GMT). The Resource array is passed as a parameter to the postit function.
