...
bot_api_token = '215546528:AAGWO9T11JAHX2QXlqBBcedAVRBd-u0Sdso' #telegram bot api token

def post(chat_id,text): #Function to post a text message to a specific chat_id
    requests.request("post","https://api.telegram.org/bot{0}/sendMessage".format(bot_api_token),params ={'chat_id':chat_id,'text':text})
